...
public class LoadStartEvent extends Event<LoadStartEvent> {

    public static final String EVENT_NAME = "loadStart";
    ...
    public LoadStartEvent(int viewId, long timestampMs, String title, boolean isLoading, String url, boolean canGoBack, boolean canGoForward) {
        super(viewId);
